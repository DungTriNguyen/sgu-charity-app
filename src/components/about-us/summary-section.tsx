      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center p-4'>
        ...
        <div className='space-y-4 sm:space-y-6'>
          ...
          <div className='space-y-3 sm:space-y-4 text-gray-600'>
            ...
            <p className='text-base sm:text-lg'>
              Với hơn 10 năm kinh nghiệm, chúng tôi đã thực hiện nhiều chương
              trìnhý nghĩa, hỗ trợ hàng nghìn người có hoàn cảnh khó khăn và tạo
              cơ hội cho các tình nguyện viên đóng góp vào sự phát triển của xã
              hội.
            </p>
            <p className='text-base sm:text-lg'>
